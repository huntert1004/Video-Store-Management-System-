#ifndef RETURNVIDEOPAGE_H
#define RETURNVIDEOPAGE_H
...
// The window that opens when the Return Video button is clicked.
// QDialog means it opens on top of the home page.
class ReturnVideoPage : public QDialog
{
    Q_OBJECT

public:
    // parent is the window that opened this one
    explicit ReturnVideoPage(QWidget* parent = nullptr);

private slots:
    // Runs when the user clicks Return
    void returnVideo();

private:
    // Labels
    QLabel* titleLabel;      // says "Return Video" at the top
